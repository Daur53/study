                                ...
                                <div class="panel-content image-gallery">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 image">
                                            <img src="img/demo/gallery/<?php echo $img['filename'];?>">
                                            <a class="btn btn-danger" href="task_18_handler.php?id=<?php echo $img['id'];?>" onclick="confirm('Вы уверены?');">Удалить</a>
                                        </div>
                                       <?php endforeach;?>
                                    </div>
                                </div>
